...
public class JwtUtils {
	...
	public Map<String, Object> generateToken(OtpLog otpLog, Collection<SimpleGrantedAuthority> authorities) {
		...
		String accessToken = Jwts.builder()
				...
				.setIssuer("Technoelevate Group").setSubject(otpLog.getEmail()).setAudience("you")
				.claim("user_id", otpLog.getUserId())
