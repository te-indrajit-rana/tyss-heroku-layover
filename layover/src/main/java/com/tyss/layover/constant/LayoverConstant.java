...
public class LayoverConstant {
	...
	public static final String ONE_TIME_PASSCODE_HAS_BEEN_SENT_TO = "One Time Passcode has been sent to ";
	...
	public static final String ACCESS_TOKEN_AND_REFRESH_TOKEN_GENRATED_SUCCESSFULLY = "Access Token And Refresh Token Genrated Successfully";
